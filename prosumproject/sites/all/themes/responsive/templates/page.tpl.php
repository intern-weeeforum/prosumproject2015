...
<div id="copyright" class="container">
 <div class="credit"><?php print t('Copyright'); ?> &copy; ProSUM <?php echo date("Y"); ?> <?php print $site_name; ?> <br/> <?php /*print t('Developed by'); */?> <!--<a href="http://www.devsaran.com" target="_blank">Devsaran</a>.--></div>
  <div class="clear"></div>
</div>